A collection of solutions to selected challenges from the r/dailyprogrammer subreddit. A link to a thread with detailed description of the challenge can be found in the source code of each solution.
